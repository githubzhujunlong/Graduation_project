...
class Pagination(object):
    ...
    def html(self):
        ...
        page_str_list.append('<li class=""><a href="?{}">首页</a></li>'.format(self.query_dict.urlencode()))
        ...
        if self.page < self.total_page_count:
            self.query_dict.setlist(self.page_param, [self.page + 1])
            prev = '<li class=""><a href="?{}">下一页</a></li>'.format(self.query_dict.urlencode())
        else:
        ...
        """ 尾页 """
        self.query_dict.setlist(self.page_param, [self.total_page_count])
        page_str_list.append('<li class=""><a href="?{}">尾页</a></li>'.format(self.query_dict.urlencode()))
        ...
        """)
        page_str_list.append('<li style="height:34px;line-height:34px;" class="">共{}条数据</li>'.format(len(self.query_set)))
